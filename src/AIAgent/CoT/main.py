...
client = OpenAI(base_url="http://192.168.0.241:8080/v1", api_key="1234567890")

MODEL = "Qwopus3.5-27B-v3-Q4_K_M.gguf"
...
response = client.chat.completions.create(
    model=MODEL, messages=[{"role": "user", "content": few_shot_prompt}]
)
...
response = client.chat.completions.create(
    model=MODEL, messages=[{"role": "user", "content": zero_shot_prompt}]
)
